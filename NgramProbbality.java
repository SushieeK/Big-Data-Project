...
public class nGramProb {
    ...
    public static void main(String[] args) throws Exception {
        ...
        job1.setJarByClass(nGramProb.class);
        ...
        job2.setJarByClass(nGramProb.class);
        ...
        job3.setJarByClass(nGramProb.class);
    ...
    public static String getWord(StringTokenizer itr) {
        ...
        while (itr.hasMoreTokens() && word.equals("")) {
            word = nGramProb.cleanInput(itr.nextToken());
        }
        return word;
    }
    ...
    public static class NgramTypeTokenCountMapper extends Mapper<Object, Text, Text, Text> {
        ...
        public void map(Object key, Text value, Context context
            ...
            while (itr.hasMoreTokens()) {
                String third = nGramProb.cleanInput(itr.nextToken());
